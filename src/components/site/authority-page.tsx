...
export function OfferAuthorityPage({ page }: { page: OfferPage }) {
  return <>
    <PageHero eyebrow="Commercial offer / bounded assessment" title={page.title} description={page.description} primaryHref="/contact" primaryLabel="Discuss this assessment" secondaryHref={page.relatedProof.href} secondaryLabel="Review related proof" />
    ...
    <CtaBand title="Start with the constraint, not a generic scope." description="Schedule an operating conversation to confirm the executive question, evidence available, and whether this assessment is the right next move." />
  </>;
}
