...
export const metadata: Metadata = {
  ...
  title: {
    default: "TKO Solutions | Healthcare Transformation & Operating Model Advisory",
  ...
  openGraph: {
    ...
    url: absoluteUrl("/"),
    siteName: site.name,
    title: "TKO Solutions | Healthcare Transformation & Operating Model Advisory",
    description: site.description,
    images: [{ url: site.socialImage, width: 1200, height: 630, alt: "TKO Solutions healthcare transformation and operating-model advisory." }],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const personJsonLd = {
    ...
    "@type": "Person",
    name: "Todd Kovalsky",
    jobTitle: "Healthcare Transformation & Operating Model Strategist",
    worksFor: {
      "@type": "Organization",
      name: site.name,
      url: site.url,
    ...
    knowsAbout: [
      ...
      "Operating Model Design",
      "Provider Experience",
      "Governed AI and Workflow Transformation",
