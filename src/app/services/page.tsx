  ...
  return (
    <>
      ...
      <Section id="delivery-partners" className="bg-surface !py-14 md:!py-18">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]"><SectionHeader eyebrow="Delivery partners" title="TKO can work alongside internal teams and established firms." description="I can define the operating model, govern decisions and dependencies, and provide healthcare specialist depth while your internal, engineering, or integration teams retain delivery accountability." /><div><p className="text-base leading-7 text-muted">Partner arrangements are scoped around a named transformation and capability need. TKO is not marketed as low-cost subcontract labor and does not publish an hourly rate card.</p><LinkButton href="/contact?intent=partner" variant="secondary" className="mt-7">Discuss Delivery-Partner Support</LinkButton></div></div>
      </Section>
