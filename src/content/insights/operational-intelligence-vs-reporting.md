...
That is why TKO treats reporting quality as one input to the [Prior Authorization Performance Diagnostic](/services/program-recovery-review), not the whole answer. The diagnostic question is not "do we have a dashboard?" It is "can leadership explain where the case waits, why it requires rework, and what evidence supports the next change?"
